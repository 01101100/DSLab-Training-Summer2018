...
class KMeans:
	...
	def load_data(self,data_path):
		def spare_to_dense(sparse_r_d,vocab_size):
        ...
        for data_id,d in enumerate(d_lines):
            ...
            r_d = spare_to_dense(sparse_r_d=features[2],vocab_size=vocab_size)
